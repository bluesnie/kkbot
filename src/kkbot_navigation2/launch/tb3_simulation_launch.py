...
def generate_launch_description():
    ...
    # filter mask
    param_substitutions = {"use_sim_time": use_sim_time, "yaml_filename": filter_mask}
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        "robot_name", default_value="kkbot", description="name of the robot"
    )
    ...
    declare_mask_yaml_file_cmd = DeclareLaunchArgument(
        "mask", default_value=os.path.join(tb3_map_dir, "tb3_keepout_mask.yaml")
    )
